...
export const DEFAULT_MODELS: Record<AIProvider, AIModel[]> = {
  ...
  kie: [
    ...
    },
    {
      ...
      costTier: 'low',
      capabilities: ['chat', 'vision', 'code'],
      description: 'Fast Gemini 2.5 via Kie.ai',
    },
    {
      id: 'gemini-2.5-pro',
      name: 'Gemini 2.5 Pro',
      ...
      costTier: 'medium',
      capabilities: ['chat', 'vision', 'code', 'reasoning'],
      description: 'Gemini 2.5 Pro via Kie.ai',
    },
    {
      id: 'gemini-3-flash',
      name: 'Gemini 3 Flash',
      ...
      costTier: 'low',
      capabilities: ['chat', 'vision', 'code', 'reasoning'],
      description: 'Fast next-gen Gemini via Kie.ai',
    },
    {
      id: 'gemini-3-pro',
      name: 'Gemini 3 Pro',
      ...
      costTier: 'medium',
      capabilities: ['chat', 'vision', 'code', 'reasoning'],
      description: 'Gemini 3 Pro via Kie.ai',
    },
  ],
}
